...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between">
            ...
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                Total Brands <span class="px-1 rounded-md bg-indigo-500 text-white"><?php echo e(count($brands)); ?></span>
            </h2>
        </div>
     <?php $__env->endSlot(); ?>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mt-10 bg-white shadow-md text-gray-700">
        <div class="flex justify-between py-8">
            ...
            <div>
                <a href="<?php echo e(route('add.brand')); ?>" class="bg-indigo-500 px-3 py-2 rounded-md text-white hover:bg-indigo-600 focus:ring focus:ring-indigo-300 ..."><i class="fa fa-plus"></i></a>
                ...
                <div id="trashDropdown" class="bg-white p-2 shadow-xl absolute border mt-5 hidden flex flex-col rounded">
                    <a href="<?php echo e(url('/brand/trash/list/')); ?>" class="p-2 text-sm hover:bg-indigo-200 sm:text-none"><i class="fa fa-list"><span class="pl-2">Trash List</span></i></a>
            ...
            <table class="w-full border text-left">
                ...
                <tbody>
                    ...
                    <tr class="border-y border-indigo-500 ...">
                        <td  class="p-3"><?php echo e($brands->firstItem()+$loop->index); ?></td>
                        <td  class="p-3"><?php echo e($data->brand_name); ?></td>
                        <td  class="p-3"><img src="<?php echo e(asset($data->brand_img)); ?>" class="w-20 h-auto" alt=""></td>
                        ...
                        <td>
                            <a href="<?php echo e(url('/edit/brand/'.$data->id)); ?>" class="bg-blue-600 py-1 px-2 text-white rounded-md hover:bg-blue-700 focus:ring focus:ring-blue-300"><i class="fa fa-wrench"></i></a>
                            <a href="<?php echo e(url('/delete/brand/'.$data->id)); ?>" class="bg-red-600 py-1 px-2 text-white rounded-md hover:bg-red-700 focus:ring focus:ring-red-300"><i class="fa fa-trash-alt"></i></a>
                        </td>
                    </tr>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\laravel-crud-operation-master\resources\views/backend/brands/index.blade.php ENDPATH**/ ?>